	...
	//edited code
	components new TimerMilliC() as EditedTestTimer;
	...
	//edited code
	TestDisseminationC.EditedTestTimer -> EditedTestTimer;
	TestDisseminationC.EditedTestRadioControl -> ActiveMessageC;
